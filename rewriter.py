                ...
                for table in tables_in_from:
                    if table.this.this in column_information:
                      ...
                      if table.this.this in self.cte:
                        ...
                        for table_in_cte in self.cte[table.this.this].find_all(exp.Table):
                          if table_in_cte.this.this in self.cte:
                            new_cte_expression.insert(0, self.cte[table_in_cte.this.this])
                        new_cte = exp.With()
                        ...
                        if new_subquery.sql() in subquery_2_name:
                          subquery_exp = sqlglot.parse_one(subquery_2_name[new_subquery.sql()])
...
for i in  [2]:
    ...
    with open(f"./tpch/query{i}.sql", "w") as f:
