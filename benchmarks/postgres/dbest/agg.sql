...
select count (ss_list_price)     from store_sales where ss_quantity       between 1      and 20
select count (ss_list_price)     from store_sales where ss_quantity       between 21     and 40
select count (ss_list_price)     from store_sales where ss_quantity       between 41     and 60
select count (ss_list_price)     from store_sales where ss_quantity       between 61     and 80
select count (ss_list_price)     from store_sales where ss_quantity       between 81     and 100
