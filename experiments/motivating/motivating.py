...
def run_exp(args):
    ...
    for _ in range(args.repeats):
        ...
        print(
            f"Covered: {covered}, Target error: {target_error}, Achieved error: {achieved_error}"
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--db_path",
        type=str,
        default="../../../.cache/aqp/tpch_1t.duckdb",
        help="path to db",
    )
    parser.add_argument("--sample_rate", type=float, default=0.1, help="sample rate")
    parser.add_argument(
        "--repeats", type=int, default=100, help="number of repeatitions"
    )
